        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="panel">
                <div class="row widget-row-in">
                    <?php if (get_permission('students_count_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/fees/student_count">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fa fa-users"></i>
                                            <h5 class="text-muted"><?php echo translate('students_count'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $students = $this->dashboard_model->getStudentsCounter('', $school_id);
                                                echo $students['snumber'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="box-top-line line-color-primary">
                                                <span class="text-muted text-uppercase"><?php echo translate(''); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <?php if (get_permission('new_admissions_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/fees/new_admissions">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fas fa-child"></i>
                                            <h5 class="text-muted"><?php echo translate('new_admissions'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $admissions = $this->dashboard_model->getAdmissionsCounter('', $school_id);
                                                echo $admissions['nadmission'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="box-top-line line-color-primary">
                    ...
                    <?php if (get_permission('student_details_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/fees/student_details">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-user-check"></i>
                                            <h5 class="text-muted"><?php echo translate('student_details'); ?></h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
<!--                                            <h3 class="counter text-right mt-md text-primary">--><?php
//                                                $clients = $this->dashboard_model->getFranchisesCounter('', $school_id);
//                                                echo $clients['fnumber'];
//                                            ?><!--</h3>-->
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="box-top-line line-color-primary">
                    ...
                    <?php if (get_permission('student_attendance_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/attendance/studentwise_report">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-fingerprint"></i>
                                            <h5 class="text-muted"><?php echo translate('student_attendance'); ?></h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
<!--                                            <h3 class="counter text-right mt-md text-primary">--><?php
//                                                $clients = $this->dashboard_model->getFranchisesCounter('', $school_id);
//                                                echo $clients['fnumber'];
//                                            ?><!--</h3>-->
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="panel">
                <div class="row widget-row-in">
                    <?php if (get_permission('fees_report_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/fees/payment_history">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-money-check-alt"></i>
                                            <h5 class="text-muted"><?php echo translate('fees_report'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
<!--                                            <h3 class="counter text-right mt-md text-primary">--><?php
//                                                $clients = $this->dashboard_model->getFranchisesCounter('', $school_id);
...
//                                                ?><!--</h3>-->
                    ...
                    <?php } ?>
                    <?php if (get_permission('monthly_finance_report_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="https://iss.iub.edu.pk/accounting/monthly_finance_report">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-money-check-alt"></i>
                                            <h5 class="text-muted"><?php echo translate('monthly_finance_report'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
<!--                                            <h3 class="counter text-right mt-md text-primary">--><?php
//                                                $clients = $this->dashboard_model->getFranchisesCounter('', $school_id);
