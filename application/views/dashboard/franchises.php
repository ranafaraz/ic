        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="panel">
                <div class="row widget-row-in">
                    <?php if (get_permission('bahawalpur_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fas fa-city"></i>
                                            <h5 class="text-muted"><?php echo translate('bahawalpur'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $franchises = $this->dashboard_model->getBWPFranchisesCounter('', $school_id);
                                                echo $franchises['fnumber'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="box-top-line line-color-primary">
                                                <span class="text-muted text-uppercase"><?php echo translate('total_count'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <?php } ?>
                    <?php if (get_permission('khanpur_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fa fa-building"></i>
                                            <h5 class="text-muted"><?php echo translate('khanpur'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $franchises = $this->dashboard_model->getKPRFranchisesCounter('', $school_id);
                                                echo $franchises['fnumber'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <?php } ?>
                    <?php if (get_permission('rahimyarkhan_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fa fa-building"></i>
                                            <h5 class="text-muted"><?php echo translate('rahimyarkhan'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $franchises = $this->dashboard_model->getRYKFranchisesCounter('', $school_id);
                                                echo $franchises['fnumber'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <?php } ?>
                    <?php if (get_permission('bahawalnagar_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fa fa-building"></i>
                                            <h5 class="text-muted"><?php echo translate('bahawalnagar'); ?></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right mt-md text-primary"><?php
                                                $franchises = $this->dashboard_model->getBWNFranchisesCounter('', $school_id);
                                                echo $franchises['fnumber'];
                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
