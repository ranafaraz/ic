                                ...
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-school"></i>
                                            <h5 class="text-muted"><?php echo translate('IUB'); ?></h5>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="box-top-line line-color-primary">
                                                <span class="text-muted text-uppercase"><?php echo translate('total_franchises_owned'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <?php if (get_permission('city_branch_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6">
                            <div class="panel-body">
                                ...
                                <div class="widget-col-in row">
                                    <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-school"></i>
                                        <h5 class="text-muted"><?php echo translate('hafiz_sikandar'); ?></h5> </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <h3 class="counter text-right mt-md text-primary"><?php
                                                    $clients = $this->dashboard_model->getFranchisesCounter('', $school_id);
                                                    echo $clients['fnumber'];
