        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="panel">
                <div class="row widget-row-in">
                    <?php if (get_permission('main_baghdad_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                    <div class="widget-col-in row">
                                        <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-school"></i>

                                            <h5 class="text-muted"><?php echo translate('main_baghdad'); ?></h5>
                    ...
                    <?php } ?>
                    <?php if (get_permission('city_branch_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6">
                            <div class="panel-body">
                                <a href="#">
                                <div class="widget-col-in row">
                                    <div class="col-md-12 col-sm-12 col-xs-12"> <i class="fas fa-school"></i>
                                        <h5 class="text-muted"><?php echo translate('city_branch'); ?></h5> </div>
                                    <!--                                    <div class="col-md-6 col-sm-6 col-xs-6">-->
                    ...
                    <?php } ?>
                    <?php if (get_permission('khanpur_branch_widget', 'is_view')) { ?>
                        <div class="col-lg-<?php echo $widget1; ?> col-sm-6 ">
                            <div class="panel-body">
                                <a href="#">
                                <div class="widget-col-in row">
                                    <div class="col-md-6 col-sm-6 col-xs-6"> <i class="fas fa-school" ></i>
                                        <h5 class="text-muted"><?php echo translate('khanpur_branch'); ?></h5> </div>
                                    <!--                                    <div class="col-md-6 col-sm-6 col-xs-6">-->
                                    <!--                                        <h3 class="counter text-right mt-md text-primary">--><?php
                                    //                                            if (!empty($school_id))
