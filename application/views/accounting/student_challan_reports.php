        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="col-md-6 <?php echo $widget; ?> mb-sm">
...
<!--                                <input type="text" class="form-control daterange" name="daterange" value="--><?php //echo set_value('daterange', date("Y/m/d") . ' - ' . date("Y/m/d")); ?><!--"  />-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
                </div>
            ...
            <section class="panel appear-animation" data-appear-animation="<?php echo $global_config['animations'];?>" data-appear-animation-delay="100">
                ...
                <div class="panel-body">
                    <div class="mb-md mt-md">
                        ...
                        <table class="table table-bordered table-condensed" id="rowGroup">
                            <thead>
                            <tr>
...
<!--                                <th>--><?//=translate('Grade')?><!--</th>-->
                                ...
                                <th><?=translate('No of Challans')?></th>
                                <th><?=translate('Fees Paid')?></th>
...
<!--                                    <td>--><?php //echo $row['name_numeric'];?><!--</td>-->
                                    ...
                                    <td><?php echo date('M', strtotime("2022-".$row['month']."-01"))?></td>
