			...
			<div class="panel-body">
				...
				<?php endif; ?>
                    ...
                    <div class="col-md-<?php echo $widget; ?> mb-sm">
                        <div class="form-group">
                            <label class="control-label"><?=translate('shift')?> </label>
                            <?php
                                ...
                                <div class="invoice">
                                    ...
                                    <div class="table-responsive br-none">
                                        <table class="table invoice-items table-hover mb-none">
                                            <thead >
                                            <tr>
<!--                                                <th COLSPAN="1" style="background-color:#cfc0c0; "></th>-->
<!--                                                <th colspan="1" style="text-align: right; background-color: #cfc0c0; font-size: x-large">Shift:</th>-->
                                                <th colspan="4" style="text-align: center; background-color: #cfc0c0; font-size: x-large"><?php echo @$invoicelist[0]['shift_name']; ?></th>
                                            </tr>
